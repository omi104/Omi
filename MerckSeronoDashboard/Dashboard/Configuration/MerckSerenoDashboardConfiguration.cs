...
namespace Dashboard.Configuration
{
    ...
    public class MerckSerenoDashboardConfiguration:DashboardConfiguration
    {
        public MerckSerenoDashboardConfiguration()
        {
            HasName("MerckSereno");//ReckittBenckiserDashboard
            HasTitle("Merck Sereno Sales Dashboard");
            ...
            Layout.HasConfig(GetCurrentPeriod).HasController<MerckSerenoDashboardLayoutController>();
            Reload.If(true);
        ...
        private void ConfigureNavigations()
        {
            ...
            //HasNavigation(new AllRegionsNavigationConfiguration(NavigationItems.NavAllRegions()));
        }
